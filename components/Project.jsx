...
const Project = ( {title, bgImage, techSkills, projectPageUrl } ) => {
  return (
    <div className='relative flex items-center justify-center w-full h-auto shadow-md shadow-[#602e9e] rounded-xl p-2 group hover:bg-gradient-to-r from-[#602e9e] to-[#709dff]'>
        ...
        <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
            ...
            <Link href={projectPageUrl}>
                <p className='text-center text-lg py-2 w-[60%] m-auto rounded-lg bg-white text-gray-700 font-bold cursor-pointer'>More Info</p>
            </Link>
        </div>
    </div>
  )
